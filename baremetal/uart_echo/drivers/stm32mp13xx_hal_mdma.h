...
typedef struct {
   ...
   uint32_t SecureMode; /*!< Specifies if the MDMA master transactions are done
                           in secure mode. This parameter can be a value of @ref
                           MDMA_Secure_Mode */
   ...
   uint32_t
       SourceBurst; /*!< Specifies the Burst transfer configuration for the
                       ...
                       value , the BURST must be programmed as to ensure that
                       the burst size will be lower than BufferTransferLength */
...
typedef struct {
   ...
   uint32_t
       PostRequestMaskAddress; /*!< specifies the address to be updated
                                  (written) with PostRequestMaskData after a
                                  request is served. PostRequestMaskAddress and
...
#define MDMA_REQUEST_DMA2_Stream7_TC                                           \
   ((uint32_t)0x0000000FU) /*!< MDMA HW request is DMA2 Stream 7 Transfer      \
                              Complete Flag   */
#if defined(DMA3)
#define MDMA_REQUEST_DMA3_Stream0_TC                                           \
   ((uint32_t)0x00000010U) /*!< MDMA HW request is DMA3 Stream 0 Transfer      \
                              Complete Flag   */
#define MDMA_REQUEST_DMA3_Stream1_TC                                           \
   ((uint32_t)0x00000011U) /*!< MDMA HW request is DMA3 Stream 1 Transfer      \
                              Complete Flag   */
#define MDMA_REQUEST_DMA3_Stream2_TC                                           \
   ((uint32_t)0x00000012U) /*!< MDMA HW request is DMA3 Stream 2 Transfer      \
                              Complete Flag   */
#define MDMA_REQUEST_DMA3_Stream3_TC                                           \
   ((uint32_t)0x00000013U) /*!< MDMA HW request is DMA3 Stream 3 Transfer      \
                              Complete Flag   */
#define MDMA_REQUEST_DMA3_Stream4_TC                                           \
   ((uint32_t)0x00000014U) /*!< MDMA HW request is DMA3 Stream 4 Transfer      \
                              Complete Flag   */
#define MDMA_REQUEST_DMA3_Stream5_TC                                           \
   ((uint32_t)0x00000015U) /*!< MDMA HW request is DMA3 Stream 5 Transfer      \
                              Complete Flag   */
#define MDMA_REQUEST_DMA3_Stream6_TC                                           \
   ((uint32_t)0x00000016U) /*!< MDMA HW request is DMA3 Stream 6 Transfer      \
                              Complete Flag   */
#define MDMA_REQUEST_DMA3_Stream7_TC                                           \
   ((uint32_t)0x00000017U) /*!< MDMA HW request is DMA3 Stream 7 Transfer      \
                              Complete Flag   */
#endif                     /* DMA3 */
#define MDMA_REQUEST_FMC_DATA                                                  \
   ((uint32_t)0x00000018U) /*!< MDMA HW request is NAND data transfer (Tx or   \
                              Rx) channel  */
#define MDMA_REQUEST_FMC_ERROR                                                 \
   ((uint32_t)0x00000019U) /*!< MDMA HW request is NAND ECC/BCH Error channel  \
                            */
#define MDMA_REQUEST_QUADSPI_FIFO_TH                                           \
   ((uint32_t)0x0000001AU) /*!< MDMA HW request is QSPI FIFO threshold Flag */
#define MDMA_REQUEST_QUADSPI_TC                                                \
   ((uint32_t)0x0000001BU) /*!< MDMA HW request is QSPI Transfer complete Flag \
                            */
#define MDMA_REQUEST_CRYP1_IN                                                  \
   ((uint32_t)0x0000001CU) /*!< MDMA HW request is CRYP1 4 word request from   \
                              input        */
#define MDMA_REQUEST_CRYP1_OUT                                                 \
   ((uint32_t)0x0000001DU) /*!< MDMA HW request is CRYP1 4 word request from   \
                              output       */
#define MDMA_REQUEST_HASH1_IN                                                  \
   ((uint32_t)0x0000001EU) /*!< MDMA HW request is HASH1 16 word request from  \
                              input       */
#define MDMA_REQUEST_SAES_IN                                                   \
   ((uint32_t)0x0000001FU) /*!< MDMA HW request is SAES request from input */
#define MDMA_REQUEST_SAES_OUT                                                  \
   ((uint32_t)0x00000020U) /*!< MDMA HW request is SAES request from output */
 ...
 * @{
 */
#define MDMA_SECURE_MODE_DISABLE                                               \
   ((uint32_t)0x00000000U) /*!< Secure Mode disabled  */
#define MDMA_SECURE_MODE_ENABLE                                                \
   ((uint32_t)MDMA_CCR_SM) /*!< Secure Mode enabled   */
...
#define MDMA_SRC_INC_BYTE                                                      \
   ((uint32_t)MDMA_CTCR_SINC_1) /*!< Source address pointer is incremented by  \
                                   a BYTE (8 bits)          */
#define MDMA_SRC_INC_HALFWORD                                                  \
   ((uint32_t)MDMA_CTCR_SINC_1 |                                               \
    (uint32_t)MDMA_CTCR_SINCOS_0) /*!< Source address pointer is incremented   \
                                     by a half Word (16 bits)    */
#define MDMA_SRC_INC_WORD                                                      \
   ((uint32_t)MDMA_CTCR_SINC_1 |                                               \
    (uint32_t)MDMA_CTCR_SINCOS_1) /*!< Source address pointer is incremented   \
                                     by a Word (32 bits)         */
#define MDMA_SRC_INC_DOUBLEWORD                                                \
   ((uint32_t)MDMA_CTCR_SINC_1 |                                               \
    (uint32_t)MDMA_CTCR_SINCOS) /*!< Source address pointer is incremented by  \
...
#define MDMA_SRC_DEC_HALFWORD                                                  \
   ((uint32_t)MDMA_CTCR_SINC |                                                 \
    (uint32_t)MDMA_CTCR_SINCOS_0) /*!< Source address pointer is decremented   \
                                     by a half Word (16 bits)    */
#define MDMA_SRC_DEC_WORD                                                      \
   ((uint32_t)MDMA_CTCR_SINC |                                                 \
    (uint32_t)MDMA_CTCR_SINCOS_1) /*!< Source address pointer is decremented   \
                                     by a Word (32 bits)         */
#define MDMA_SRC_DEC_DOUBLEWORD                                                \
   ((uint32_t)MDMA_CTCR_SINC |                                                 \
    (uint32_t)MDMA_CTCR_SINCOS) /*!< Source address pointer is decremented by  \
                                   a double Word (64 bits)) */
...
#define MDMA_DEST_INC_BYTE                                                     \
   ((uint32_t)MDMA_CTCR_DINC_1) /*!< Source address pointer is incremented by  \
                                   a BYTE (8 bits)          */
#define MDMA_DEST_INC_HALFWORD                                                 \
   ((uint32_t)MDMA_CTCR_DINC_1 |                                               \
    (uint32_t)MDMA_CTCR_DINCOS_0) /*!< Source address pointer is incremented   \
                                     by a half Word (16 bits)    */
#define MDMA_DEST_INC_WORD                                                     \
   ((uint32_t)MDMA_CTCR_DINC_1 |                                               \
    (uint32_t)MDMA_CTCR_DINCOS_1) /*!< Source address pointer is incremented   \
                                     by a Word (32 bits)         */
#define MDMA_DEST_INC_DOUBLEWORD                                               \
   ((uint32_t)MDMA_CTCR_DINC_1 |                                               \
    (uint32_t)MDMA_CTCR_DINCOS) /*!< Source address pointer is incremented by  \
                                   a double Word (64 bits)) */
...
#define MDMA_DEST_DEC_HALFWORD                                                 \
   ((uint32_t)MDMA_CTCR_DINC |                                                 \
    (uint32_t)MDMA_CTCR_DINCOS_0) /*!< Source address pointer is decremented   \
                                     by a half Word (16 bits)    */
#define MDMA_DEST_DEC_WORD                                                     \
   ((uint32_t)MDMA_CTCR_DINC |                                                 \
    (uint32_t)MDMA_CTCR_DINCOS_1) /*!< Source address pointer is decremented   \
                                     by a Word (32 bits)         */
#define MDMA_DEST_DEC_DOUBLEWORD                                               \
   ((uint32_t)MDMA_CTCR_DINC |                                                 \
    (uint32_t)MDMA_CTCR_DINCOS) /*!< Source address pointer is decremented by  \
                                   a double Word (64 bits)) */
...
#define MDMA_DATAALIGN_PACKENABLE                                              \
   ((uint32_t)MDMA_CTCR_PKE) /*!< The source data is packed/un-packed into     \
...
#define MDMA_DATAALIGN_RIGHT_SIGNED                                            \
   ((uint32_t)MDMA_CTCR_PAM_0) /*!< Right Aligned, Sign extended ,             \
                                    ...
                                    Source data size is smaller than           \
...
#define IS_MDMA_REQUEST(__REQUEST__)                                           \
   (((__REQUEST__) == MDMA_REQUEST_SW) ||                                      \
    ((__REQUEST__) <= MDMA_REQUEST_SAES_OUT))
