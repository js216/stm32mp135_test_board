...
typedef struct {
   uint32_t SrcAddress; /*!< Specifies the transfer source address
                           ...
                           and Max_Data = 0xFFFFFFFF. This feature can be
   ...
   uint32_t
       BlockDataLength; /*!< Specifies the length of a block transfer in bytes
                             This parameter must be a value between Min_Data = 0
                           and Max_Data = 0x00010000. This feature can be
                           modified afterwards using unitary function
                             @ref LL_MDMA_SetBlkDataLength() */

   uint32_t
       BlockRepeatCount; /*!< Specifies the Block Repeat Count
                              This parameter must be a value between Min_Data =
                            0 and Max_Data = 0x00000FFF. This feature can be
                            modified afterwards using unitary function
   ...
   uint32_t
       BlockRepeatDestAddrUpdateVal; /*!< Specifies the block repeat destination
                                        address update value. This parameter can
                                        be a value Between 0 to 0x0000FFFF This
   ...
   uint32_t
       BlockRepeatSrcAddrUpdateVal; /*!< Specifies the block repeat source
                                       address update value. This parameter can
                                       be a value Between 0 to 0x0000FFFF This
                                       feature can be modified afterwards using
                                       unitary function
   ...
   uint32_t
       HalfWordEndianess; /*!< Specifies the Half Word transfer endianness
                               This parameter can be a value of @ref
                             MDMA_LL_EC_HALFWORD_ENDIANNESS. This feature can be
                             modified afterwards using unitary function
   ...
   uint32_t
       BufferableWriteMode; /*!< Specifies the transfer Bufferable Write Mode.
                                 This parameter can be a value of @ref
                               MDMA_LL_EC_BUFF_WRITE_MODE This feature can be
                               modified afterwards using unitary function
                                 @ref LL_MDMA_EnableBufferableWrMode()
                                 and LL_MDMA_DisableBufferableWrMode */

   uint32_t
       PaddingAlignment; /*!< Specifies the transfer Padding and Alignment.
                              This parameter can be a value of @ref
                            MDMA_LL_EC_PADDING_ALIGNMENT_MODE This feature can
                            be modified afterwards using unitary function
   ...
   uint32_t PackMode; /*!< Specifies the transfer Packing enabled or disabled.
                         ...
                         afterwards using unitary function
                           @ref LL_MDMA_EnablePacking() and
                         LL_MDMA_DisablePacking() */

   uint32_t BufferTransferLength; /*!< Specifies the length of a buffer transfer
                                     in bytes This parameter must be a value
   ...
   uint32_t
       MaskAddress; /*!< Specifies the address to be updated (written) with
                       MaskData after a request is served. MaskAddress and
                       MaskData could be used to automatically clear a
                       peripheral flag when the request is served This parameter
                       can be a value Between 0 to 0xFFFFFFFF This feature can
                       be modified afterwards using unitary function
...
#define LL_MDMA_WORD_ENDIANNESS_PRESERVE                                       \
   0x00000000U /*!< Little endianness preserved for words */
#define LL_MDMA_WORD_ENDIANNESS_EXCHANGE                                       \
   MDMA_CCR_WEX /*!< word order exchanged when destination data size is double \
                   word  */
...
#define LL_MDMA_HALFWORD_ENDIANNESS_PRESERVE                                   \
   0x00000000U /*!< Little endianness preserved for half words */
#define LL_MDMA_HALFWORD_ENDIANNESS_EXCHANGE                                   \
   MDMA_CCR_HEX /*!< half word order exchanged when destination data size is   \
                   word or double word  */
...
#define LL_MDMA_BYTE_ENDIANNESS_PRESERVE                                       \
   0x00000000U /*!< Little endianness preserved for bytes */
#define LL_MDMA_BYTE_ENDIANNESS_EXCHANGE                                       \
   MDMA_CCR_BEX /*!< byte order exchanged when destination data size is half   \
...
#define LL_MDMA_BUFFER_TRANSFER                                                \
   0x00000000U /*!< Each MDMA request (SW or HW) triggers a buffer transfer */
#define LL_MDMA_BLOCK_TRANSFER                                                 \
   MDMA_CTCR_TRGM_0 /*!< Each MDMA request (SW or HW) triggers a block         \
                       transfer */
#define LL_MDMA_REPEAT_BLOCK_TRANSFER                                          \
   MDMA_CTCR_TRGM_1 /*!< Each MDMA request (SW or HW) triggers a repeated      \
                       block transfer */
#define LL_MDMA_FULL_TRANSFER                                                  \
   MDMA_CTCR_TRGM /*!< Each MDMA request (SW or HW) triggers a Full transfer   \
                     or a linked list transfer if any */
/**
 * @}
 */
...
#define LL_MDMA_DEST_INCREMENT                                                 \
   MDMA_CTCR_DINC_1 /*!< Destination address pointer is incremented after each \
                       data transfer */
#define LL_MDMA_DEST_DECREMENT                                                 \
   MDMA_CTCR_DINC /*!< Destination address pointer is decremented after each   \
                     data transfer */
/**
 * @}
 */
...
#define LL_MDMA_SRC_INCREMENT                                                  \
   MDMA_CTCR_SINC_1 /*!< Destination address pointer is incremented after each \
                       data transfer */
#define LL_MDMA_SRC_DECREMENT                                                  \
   MDMA_CTCR_SINC /*!< Destination address pointer is decremented after each   \
                     data transfer */
/**
 * @}
 */

/** @defgroup MDMA_LL_EC_BLK_RPT_DEST_ADDR_UPDATE_MODE Block Repeat Destination
 * address Update Mode
 * @{
 */
#define LL_MDMA_BLK_RPT_DEST_ADDR_INCREMENT                                    \
   0x00000000U /*!< Destination address pointer is incremented after each      \
                  block transfer by Destination Update Value */
#define LL_MDMA_BLK_RPT_DEST_ADDR_DECREMENT                                    \
   MDMA_CBNDTR_BRDUM /*!< Destination address pointer is decremented after     \
                        each block transfer by Destination Update Value */
/**
 * @}
 */

/** @defgroup MDMA_LL_EC_SRC_BLK_RPT_ADDR_UPDATE_MODE Source Block Repeat
 * address Update Mode
 * @{
 */
...
#define LL_MDMA_BLK_RPT_SRC_ADDR_DECREMENT                                     \
   MDMA_CBNDTR_BRSUM /*!< Source address pointer is decremented after each     \
...
#define LL_MDMA_REQ_DMA1_STREAM0_TC                                            \
   0x00000000U /*!< MDMA HW Trigger (request) is DMA1 Stream 0 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA1_STREAM1_TC                                            \
   0x00000001U /*!< MDMA HW Trigger (request) is DMA1 Stream 1 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA1_STREAM2_TC                                            \
   0x00000002U /*!< MDMA HW Trigger (request) is DMA1 Stream 2 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA1_STREAM3_TC                                            \
   0x00000003U /*!< MDMA HW Trigger (request) is DMA1 Stream 3 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA1_STREAM4_TC                                            \
   0x00000004U /*!< MDMA HW Trigger (request) is DMA1 Stream 4 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA1_STREAM5_TC                                            \
   0x00000005U /*!< MDMA HW Trigger (request) is DMA1 Stream 5 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA1_STREAM6_TC                                            \
   0x00000006U /*!< MDMA HW Trigger (request) is DMA1 Stream 6 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA1_STREAM7_TC                                            \
   0x00000007U /*!< MDMA HW Trigger (request) is DMA1 Stream 7 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA2_STREAM0_TC                                            \
   0x00000008U /*!< MDMA HW Trigger (request) is DMA2 Stream 0 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA2_STREAM1_TC                                            \
   0x00000009U /*!< MDMA HW Trigger (request) is DMA2 Stream 1 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA2_STREAM2_TC                                            \
   0x0000000AU /*!< MDMA HW Trigger (request) is DMA2 Stream 2 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA2_STREAM3_TC                                            \
   0x0000000BU /*!< MDMA HW Trigger (request) is DMA2 Stream 3 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA2_STREAM4_TC                                            \
   0x0000000CU /*!< MDMA HW Trigger (request) is DMA2 Stream 4 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA2_STREAM5_TC                                            \
   0x0000000DU /*!< MDMA HW Trigger (request) is DMA2 Stream 5 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA2_STREAM6_TC                                            \
   0x0000000EU /*!< MDMA HW Trigger (request) is DMA2 Stream 6 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA2_STREAM7_TC                                            \
   0x0000000FU /*!< MDMA HW Trigger (request) is DMA2 Stream 7 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM0_TC                                            \
   0x00000010U /*!< MDMA HW Trigger (request) is DMA3 Stream 0 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM1_TC                                            \
   0x00000011U /*!< MDMA HW Trigger (request) is DMA3 Stream 1 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM2_TC                                            \
   0x00000012U /*!< MDMA HW Trigger (request) is DMA3 Stream 2 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM3_TC                                            \
   0x00000013U /*!< MDMA HW Trigger (request) is DMA3 Stream 3 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM4_TC                                            \
   0x00000014U /*!< MDMA HW Trigger (request) is DMA3 Stream 4 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM5_TC                                            \
   0x00000015U /*!< MDMA HW Trigger (request) is DMA3 Stream 5 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM6_TC                                            \
   0x00000016U /*!< MDMA HW Trigger (request) is DMA3 Stream 6 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_DMA3_STREAM7_TC                                            \
   0x00000017U /*!< MDMA HW Trigger (request) is DMA3 Stream 7 Transfer        \
                  Complete Flag   */
#define LL_MDMA_REQ_FMC_DATA                                                   \
   0x00000018U /*!< MDMA HW Trigger (request) is NAND data transfer (Tx or Rx) \
                  channel  */
#define LL_MDMA_REQ_FMC_ERROR                                                  \
   0x00000019U /*!< MDMA HW Trigger (request) is NAND ECC/BCH Error channel */
#define LL_MDMA_REQ_QUADSPI_FIFO_TH                                            \
   0x0000001AU /*!< MDMA HW Trigger (request) is QSPI FIFO threshold Flag */
#define LL_MDMA_REQ_QUADSPI_TC                                                 \
   0x0000001BU /*!< MDMA HW Trigger (request) is QSPI Transfer complete Flag   \
                */
#define LL_MDMA_REQ_CRYP1_IN                                                   \
   0x0000001CU /*!< MDMA HW Trigger (request) is CRYP1 4 word request from     \
                  input        */
#define LL_MDMA_REQ_CRYP1_OUT                                                  \
   0x0000001DU /*!< MDMA HW Trigger (request) is CRYP1 4 word request from     \
                  output       */
#define LL_MDMA_REQ_HASH1_IN                                                   \
   0x0000001EU /*!< MDMA HW Trigger (request) is HASH1 16 word request from    \
                  input       */
#define LL_MDMA_REQ_SAES_IN                                                    \
   0x0000001FU /*!< MDMA HW Trigger (request) is SAES request from input */
#define LL_MDMA_REQ_SAES_OUT                                                   \
   0x00000020U /*!< MDMA HW Trigger (request) is SAES request from output */
...
#define LL_MDMA_READ_ERROR                                                     \
   0x00000000U /*!< Last transfer error on the channel was a related to a read \
                  access    */
#define LL_MDMA_WRITE_ERROR                                                    \
   MDMA_CESR_TED /*!< Last transfer error on the channel was a related to a    \
                    write access   */
/**
 * @}
 */
...
#define LL_MDMA_GET_CHANNEL(__CHANNEL_INSTANCE__)                              \
   (((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel0))            \
        ? LL_MDMA_CHANNEL_0                                                    \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel1))          \
        ? LL_MDMA_CHANNEL_1                                                    \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel2))          \
        ? LL_MDMA_CHANNEL_2                                                    \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel3))          \
        ? LL_MDMA_CHANNEL_3                                                    \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel4))          \
        ? LL_MDMA_CHANNEL_4                                                    \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel5))          \
        ? LL_MDMA_CHANNEL_5                                                    \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel6))          \
        ? LL_MDMA_CHANNEL_6                                                    \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel7))          \
        ? LL_MDMA_CHANNEL_7                                                    \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel8))          \
        ? LL_MDMA_CHANNEL_8                                                    \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel9))          \
        ? LL_MDMA_CHANNEL_9                                                    \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel10))         \
        ? LL_MDMA_CHANNEL_10                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel11))         \
        ? LL_MDMA_CHANNEL_11                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel12))         \
        ? LL_MDMA_CHANNEL_12                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel13))         \
        ? LL_MDMA_CHANNEL_13                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel14))         \
        ? LL_MDMA_CHANNEL_14                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel15))         \
        ? LL_MDMA_CHANNEL_15                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel16))         \
        ? LL_MDMA_CHANNEL_16                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel17))         \
        ? LL_MDMA_CHANNEL_17                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel18))         \
        ? LL_MDMA_CHANNEL_18                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel19))         \
        ? LL_MDMA_CHANNEL_19                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel20))         \
        ? LL_MDMA_CHANNEL_20                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel21))         \
        ? LL_MDMA_CHANNEL_21                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel22))         \
        ? LL_MDMA_CHANNEL_22                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel23))         \
        ? LL_MDMA_CHANNEL_23                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel24))         \
        ? LL_MDMA_CHANNEL_24                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel25))         \
        ? LL_MDMA_CHANNEL_25                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel26))         \
        ? LL_MDMA_CHANNEL_26                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel27))         \
        ? LL_MDMA_CHANNEL_27                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel28))         \
        ? LL_MDMA_CHANNEL_28                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel29))         \
        ? LL_MDMA_CHANNEL_29                                                   \
    : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)MDMA_Channel30))         \
        ? LL_MDMA_CHANNEL_30                                                   \
        : LL_MDMA_CHANNEL_31)
...
#define LL_MDMA_GET_CHANNEL_INSTANCE(__MDMA_INSTANCE__, __CHANNEL__)           \
   (((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_0)) ? MDMA_Channel0 \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_1))               \
        ? MDMA_Channel1                                                        \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_2))               \
        ? MDMA_Channel2                                                        \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_3))               \
        ? MDMA_Channel3                                                        \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_4))               \
        ? MDMA_Channel4                                                        \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_5))               \
        ? MDMA_Channel5                                                        \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_6))               \
        ? MDMA_Channel6                                                        \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_7))               \
        ? MDMA_Channel7                                                        \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_8))               \
        ? MDMA_Channel8                                                        \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_9))               \
        ? MDMA_Channel9                                                        \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_10))              \
        ? MDMA_Channel10                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_11))              \
        ? MDMA_Channel11                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_12))              \
        ? MDMA_Channel12                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_13))              \
        ? MDMA_Channel13                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_14))              \
        ? MDMA_Channel14                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_15))              \
        ? MDMA_Channel15                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_16))              \
        ? MDMA_Channel16                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_17))              \
        ? MDMA_Channel17                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_18))              \
        ? MDMA_Channel18                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_19))              \
        ? MDMA_Channel19                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_20))              \
        ? MDMA_Channel20                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_21))              \
        ? MDMA_Channel21                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_22))              \
        ? MDMA_Channel22                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_23))              \
        ? MDMA_Channel23                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_24))              \
        ? MDMA_Channel24                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_25))              \
        ? MDMA_Channel25                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_26))              \
        ? MDMA_Channel26                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_27))              \
        ? MDMA_Channel27                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_28))              \
        ? MDMA_Channel28                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_29))              \
        ? MDMA_Channel29                                                       \
    : ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_MDMA_CHANNEL_30))              \
        ? MDMA_Channel30                                                       \
        : MDMA_Channel31)
                                                  ...
                                                  uint32_t Channel)
{
   ...
   return ((READ_BIT(((MDMA_Channel_TypeDef *)(mdma_base_addr +
                                               LL_MDMA_CH_OFFSET_TAB[Channel]))
                         ->CCR,
...
/**
 * @brief Configure Transfer endianness parameters : Word, Half word and Bytes
 * Endianness.
                                                  ...
                                                  uint32_t Configuration)
{
   ...
   MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr +
                                        LL_MDMA_CH_OFFSET_TAB[Channel]))
                  ->CCR,
 ...
 * or @ref LL_MDMA_DEST_BURST_4BEATS or
 *         @ref LL_MDMA_DEST_BURST_8BEATS
 *              or @ref LL_MDMA_DEST_BURST_16BEATS or @ref
 * LL_MDMA_DEST_BURST_32BEATS or
 ...
 * or @ref LL_MDMA_SRC_BURST_4BEATS or
 *         @ref LL_MDMA_SRC_BURST_8BEATS
 *              or @ref LL_MDMA_SRC_BURST_16BEATS or @ref
 * LL_MDMA_SRC_BURST_32BEATS or @ref LL_MDMA_SRC_BURST_64BEATS or @ref
 * LL_MDMA_SRC_BURST_128BEATS
 *         @arg @ref LL_MDMA_DEST_INC_OFFSET_BYTE or @ref
 * LL_MDMA_DEST_INC_OFFSET_HALFWORD or
 *         @ref LL_MDMA_DEST_INC_OFFSET_WORD or @ref
 * LL_MDMA_DEST_INC_OFFSET_DOUBLEWORD
 *         @arg @ref LL_MDMA_SRC_INC_OFFSET_BYTE or @ref
 * LL_MDMA_SRC_INC_OFFSET_HALFWORD or
 *         @ref LL_MDMA_SRC_INC_OFFSET_WORD or @ref
 * LL_MDMA_SRC_INC_OFFSET_DOUBLEWORD
 *         @arg @ref LL_MDMA_DEST_DATA_SIZE_BYTE or @ref
 * LL_MDMA_DEST_DATA_SIZE_HALFWORD or
 *         @ref LL_MDMA_DEST_DATA_SIZE_WORD or @ref
 * LL_MDMA_DEST_DATA_SIZE_DOUBLEWORD
 *         @arg @ref LL_MDMA_SRC_DATA_SIZE_BYTE or @ref
 * LL_MDMA_SRC_DATA_SIZE_HALFWORD or
 *         @ref LL_MDMA_SRC_DATA_SIZE_WORD or @ref
                                                 ...
                                                 uint32_t PaddingAlignment)
{
   ...
   MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr +
                                        LL_MDMA_CH_OFFSET_TAB[Channel]))
                  ->CTCR,
              MDMA_CTCR_PAM, PaddingAlignment);
}
                                              ...
                                              uint32_t BlkDataLength)
{
   ...
   MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr +
                                        LL_MDMA_CH_OFFSET_TAB[Channel]))
                  ->CBNDTR,
              MDMA_CBNDTR_BNDT, (BlkDataLength & MDMA_CBNDTR_BNDT_Msk));
}
                                                       ...
                                                       uint32_t Configuration)
{
   ...
   MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr +
                                        LL_MDMA_CH_OFFSET_TAB[Channel]))
                  ->CBNDTR,
              MDMA_CBNDTR_BRDUM | MDMA_CBNDTR_BRSUM, Configuration);
}
...
LL_MDMA_SetBlkRepeatDestAddrUpdate(MDMA_TypeDef *MDMAx, uint32_t Channel,
                                   uint32_t DestAdrUpdateMode)
{
   ...
   MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr +
                                        LL_MDMA_CH_OFFSET_TAB[Channel]))
                  ->CBNDTR,
              MDMA_CBNDTR_BRDUM, DestAdrUpdateMode);
}
 ...
 */
__STATIC_INLINE void
LL_MDMA_SetBlkRepeatSrcAddrUpdate(MDMA_TypeDef *MDMAx, uint32_t Channel,
                                  uint32_t SrcAdrUpdateMode)
{
   ...
   MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr +
                                        LL_MDMA_CH_OFFSET_TAB[Channel]))
                  ->CBNDTR,
              MDMA_CBNDTR_BRSUM, SrcAdrUpdateMode);
}
                                                  ...
                                                  uint32_t Channel)
{
   ...
   return (READ_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr +
                                              LL_MDMA_CH_OFFSET_TAB[Channel]))
                        ->CSAR));
}
 ...
 */
__STATIC_INLINE void
LL_MDMA_ConfigBlkRptAddrUpdateValue(MDMA_TypeDef *MDMAx, uint32_t Channel,
 ...
 */
__STATIC_INLINE void
LL_MDMA_SetBlkRptDestAddrUpdateValue(MDMA_TypeDef *MDMAx, uint32_t Channel,
                                     uint32_t DestAdrUpdateValue)
{
   uint32_t mdma_base_addr = (uint32_t)MDMAx;
 ...
 */
__STATIC_INLINE void
LL_MDMA_SetBlkRptSrcAddrUpdateValue(MDMA_TypeDef *MDMAx, uint32_t Channel,
                                    uint32_t SrcAdrUpdateValue)
{
   ...
   MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr +
                                        LL_MDMA_CH_OFFSET_TAB[Channel]))
                  ->CBRUR,
              MDMA_CBRUR_SUV, SrcAdrUpdateValue);
}
                                                ...
                                                uint32_t Configuration)
{
   ...
   MODIFY_REG(((MDMA_Channel_TypeDef *)(mdma_base_addr +
                                        LL_MDMA_CH_OFFSET_TAB[Channel]))
                  ->CTBR,
              MDMA_CTBR_DBUS | MDMA_CTBR_SBUS, Configuration);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_MDMA_SetHWTrigger(MDMA_TypeDef *MDMAx, uint32_t Channel,
                                          uint32_t HWRequest)
{
   uint32_t mdma_base_addr = (uint32_t)MDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_MDMA_SetMaskData(MDMA_TypeDef *MDMAx, uint32_t Channel,
                                         uint32_t MaskData)
{
   uint32_t mdma_base_addr = (uint32_t)MDMAx;
...
{
   return (
       (READ_BIT(MDMAx->GISR0, (MDMA_GISR0_GIF0 << (Channel & 0x0000001FU))) ==
        (MDMA_GISR0_GIF0 << (Channel & 0x0000001FU)))
           ? 1UL
           : 0UL);
}
...
uint32_t LL_MDMA_Init(MDMA_TypeDef *MDMAx, uint32_t Channel,
