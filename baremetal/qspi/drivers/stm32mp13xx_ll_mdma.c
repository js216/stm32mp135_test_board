...
#define IS_LL_MDMA_ALL_CHANNEL_INSTANCE(INSTANCE, CHANNEL)                     \
   (((INSTANCE) == MDMA) &&                                                    \
    (((CHANNEL) == LL_MDMA_CHANNEL_0) || ((CHANNEL) == LL_MDMA_CHANNEL_1) ||   \
     ((CHANNEL) == LL_MDMA_CHANNEL_2) || ((CHANNEL) == LL_MDMA_CHANNEL_3) ||   \
     ((CHANNEL) == LL_MDMA_CHANNEL_4) || ((CHANNEL) == LL_MDMA_CHANNEL_5) ||   \
     ((CHANNEL) == LL_MDMA_CHANNEL_6) || ((CHANNEL) == LL_MDMA_CHANNEL_7) ||   \
     ((CHANNEL) == LL_MDMA_CHANNEL_8) || ((CHANNEL) == LL_MDMA_CHANNEL_9) ||   \
     ((CHANNEL) == LL_MDMA_CHANNEL_10) || ((CHANNEL) == LL_MDMA_CHANNEL_11) || \
     ((CHANNEL) == LL_MDMA_CHANNEL_12) || ((CHANNEL) == LL_MDMA_CHANNEL_13) || \
     ((CHANNEL) == LL_MDMA_CHANNEL_14) || ((CHANNEL) == LL_MDMA_CHANNEL_15) || \
     ((CHANNEL) == LL_MDMA_CHANNEL_16) || ((CHANNEL) == LL_MDMA_CHANNEL_17) || \
     ((CHANNEL) == LL_MDMA_CHANNEL_18) || ((CHANNEL) == LL_MDMA_CHANNEL_19) || \
     ((CHANNEL) == LL_MDMA_CHANNEL_20) || ((CHANNEL) == LL_MDMA_CHANNEL_21) || \
     ((CHANNEL) == LL_MDMA_CHANNEL_22) || ((CHANNEL) == LL_MDMA_CHANNEL_23) || \
     ((CHANNEL) == LL_MDMA_CHANNEL_24) || ((CHANNEL) == LL_MDMA_CHANNEL_25) || \
     ((CHANNEL) == LL_MDMA_CHANNEL_26) || ((CHANNEL) == LL_MDMA_CHANNEL_27) || \
     ((CHANNEL) == LL_MDMA_CHANNEL_28) || ((CHANNEL) == LL_MDMA_CHANNEL_29) || \
     ((CHANNEL) == LL_MDMA_CHANNEL_30) || ((CHANNEL) == LL_MDMA_CHANNEL_31) || \
...
uint32_t LL_MDMA_DeInit(MDMA_TypeDef *MDMAx, uint32_t Channel)
{
   ...
   if (Channel == LL_MDMA_CHANNEL_ALL) {
      ...
      tmp = (MDMA_Channel_TypeDef *)(LL_MDMA_GET_CHANNEL_INSTANCE(MDMAx,
                                                                  Channel));
                      ...
                      LL_MDMA_InitTypeDef *MDMA_InitStruct)
{
    ...
    */
   LL_MDMA_ConfigXferEndianness(MDMAx, Channel,
    ...
    */
   LL_MDMA_ConfigBlkCounters(MDMAx, Channel, MDMA_InitStruct->BlockRepeatCount,
    ...
    * -------------------------- Configure the Transfer destination address with
    * parameter :
   ...
   LL_MDMA_ConfigBlkRptAddrUpdateValue(
       MDMAx, Channel, MDMA_InitStruct->BlockRepeatSrcAddrUpdateVal,
       MDMA_InitStruct->BlockRepeatDestAddrUpdateVal);

   /*-------------------------- MDMAx CLAR Configuration
    * -------------------------- Configure the Transfer linked list address with
    * parameter :
   ...
   LL_MDMA_ConfigBusSelection(
       MDMAx, Channel, MDMA_InitStruct->DestBus | MDMA_InitStruct->SrcBus);
                            ...
                            LL_MDMA_LinkNodeTypeDef *pNode)
{
   ...
   pNode->CTCR =
       ...
       MDMA_InitStruct->SrcDataSize | MDMA_InitStruct->DestIncMode |
       MDMA_InitStruct->SrcIncMode |
       ((MDMA_InitStruct->BufferTransferLength << MDMA_CTCR_TLEN_Pos) &
        MDMA_CTCR_TLEN_Msk);
    ...
    * - BlockRepeatDestAddrUpdateMode:   MDMA_CBNDTR_BRSUM[18] bit
    */
   pNode->CBNDTR = ((MDMA_InitStruct->BlockRepeatCount << MDMA_CBNDTR_BRC_Pos) &
                    MDMA_CBNDTR_BRC_Msk) |
                   MDMA_InitStruct->BlockRepeatDestAddrUpdateMode |
                   MDMA_InitStruct->BlockRepeatSrcAddrUpdateMode |
    ...
    */
   pNode->CBRUR =
       (MDMA_InitStruct->BlockRepeatSrcAddrUpdateVal & MDMA_CBRUR_SUV_Msk) |
       ((MDMA_InitStruct->BlockRepeatDestAddrUpdateVal << MDMA_CBRUR_DUV_Pos) &
        MDMA_CBRUR_DUV_Msk);
